            ...
            <div className="container mx-auto flex px-5 py-24 items-center justify-center flex-col">
                ...
                <div className="text-center lg:w-2/3 w-full">
                    ...
                    <div className="flex justify-center gap-6">
                        <button onClick={navigateLogin} className="btn btn-outline btn-primary px-8 text-lg">Log In</button>
                        <button onClick={navigateSignup} className="btn btn-outline px-8 text-lg">Sign Up</button>
                    </div>
                </div>
            </div>
        </section>
